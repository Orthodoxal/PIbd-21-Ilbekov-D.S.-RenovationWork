...
using RenovationWorkWarehouseApp.Models;
using System;
...
namespace RenovationWorkWarehouseApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            APIClient.PostRequest("api/Warehouse/AddComponentWarehouse", new WarehouseAddComponentBindingModel
            {
        ...
        [HttpPost]
        public void Editing(int warehouseId, string warehouseName, string ResponsibleFullName)
        {
            if (String.IsNullOrEmpty(warehouseName) || String.IsNullOrEmpty(ResponsibleFullName))
            {
                return;
